    ...
    <header className="navbar">
        <div  className='nav'>
          ...
          <div className='icons'>
              ...
              <Link to='/login' > <BiUser className="icons__user" /></Link>
              <Link to='/favorito' ><IoMdHeartEmpty className="icons__heart" /></Link>
              <Link to='/carrito' ><CartWidget className="car"/></Link>
          </div>
        </div>
