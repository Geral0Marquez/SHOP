    ...
    <div className='App' style={{marginTop: '120px'}}>
        ...
        <div className='aviso'>
            ...
            <div className='aviso__conte'>
              ...
              <Aviso text='Retirá tu pedido en el local o recibilo por transporte como correo electrónico o encomiendas.'>RECIBÍ TU PEDIDO</Aviso>
            </div>
        </div>
        ...
        <section className='sect'>
            <h2 style={{marginTop:'100px'}}>Nuevos</h2>
            <div className='loNvo'>
