...
function Contacto() {
  return (
    <section className='jsx' id="contact">
        <h3 className="contacto__titulo"> Escríbenos!</h3>
      ...
      <div className="contacto__wrapper">          
          ...
          <div className="contacto__info">
              <h3 className="contacto__titulo-wrapper">Información</h3>
                <p className="contacto__info-p">< BsGeoAlt className='icon icon-geo'/>Colombia - Medellín</p>
                <p className="contacto__info-p">< HiOutlineMail className='icon icon-email'/>geralpaez00@gmail.com</p>
                <p className="contacto__info-p">< BsWhatsapp className='icon icon-whats'/>3107924787</p>
          </div> 
      </div> 
    </section>
  )
